...
<body>
 ...
 <!-------- paging 시작 -------->
 <div id="paging" style="width:calc(100%-500); margin:20px 0">
   ...
   <c:choose>
      ...
      <c:when test="${not empty pagingVO.curPage}">
         ...
         <!-- 처음 페이지 -->
   	     <li class="page-item">
   	     	<a class="page-link" href="search.do?searchKey=name&searchWord=${searchWord}&curPage=1">
   	     		<span class="material-icons" style="color:#0079FF; font-size:9pt">
   	     		   fast_rewind
	     		</span>
			</a>
     	 </li>
		 <!-- 이전 페이지 -->
		 <li class="page-item"> 
		 	<a class="page-link" href="search.do?searchKey=name&searchWord=${searchWord}&curPage=${pagingVO.prePage}">
		 		<span class="material-icons" style="color:#0079FF; font-size:9pt">
		 			skip_previous
		 		</span>
		 	</a>
         ...
         <c:forEach begin="${beginVar}" 
			...
			<li class="active">
				<a class="page-link" href="search.do?searchKey=name&searchWord=${searchWord}&curPage=${st.index + pagingVO.curPage-2}">
         ...
         <!-- 다음 페이지 -->
		  <li class="page-item">
		  	<a class="page-link" 
		  	   href="search.do?searchKey=name&searchWord=${searchWord}&curPage=${pagingVO.nextPage}">
		  		<span class="material-icons" style="color:#0079FF; font-size:9pt">
   	     		   skip_next
	     		</span>
		  	</a>
		 ...
		 <!-- 마지막 페이지 -->
		 <li class="page-item">
		 	<a class="page-link" href="search.do?searchKey=name&searchWord=${searchWord}&curPage=${pagingVO.endPage}">
				<span class="material-icons" style="color:#0079FF; font-size:9pt">
   	     		   fast_forward
	     		</span> 
		 	</a>
