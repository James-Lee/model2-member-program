   ...
   <c:choose>
      ...
      <c:when test="${not empty pagingVO.curPage}">
         ...
         <!-- 처음 페이지 -->
   	     ...
   	     <li class="page-item">
   	     	<a class="page-link" href="viewAllPaging.do?curPage=1">
		 ...
		 <!-- 이전 페이지 -->
		 <li class="page-item"> 
		 	<a class="page-link" href="viewAllPaging.do?curPage=${pagingVO.prePage}">
		 		<span class="material-icons" style="color:#0079FF; font-size:9pt">
		 			skip_previous
		 		</span>
		 	</a>
         ...
         <!-- 다음 페이지 -->
		  <li class="page-item">
		  	<a class="page-link" href="viewAllPaging.do?curPage=${pagingVO.nextPage}">
		  		<span class="material-icons" style="color:#0079FF; font-size:9pt">
   	     		   skip_next
	     		</span>
		  	</a>
		 ...
		 <!-- 마지막 페이지 -->
		 <li class="page-item">
		 	<a class="page-link" href="viewAllPaging.do?curPage=${pagingVO.endPage}">
				<span class="material-icons" style="color:#0079FF; font-size:9pt">
   	     		   fast_forward
	     		</span> 
		 	</a>
